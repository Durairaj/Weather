                    ...
                    <ClickAwayListener onClickAway={this.handleMenuClose}>
                        <Grow
                            ...
                            <List>
                                ...
                                <MainMenuItem name={OPEN_WEATHER_CONFIG.name}
                                ...
                                <Divider/>
                                <MainMenuItem name={TREMENDOUS_WEATHER_CONFIG.name}
                                              path={TREMENDOUS_WEATHER_CONFIG.path}
                                              handleMenuClick={this.handleChangeList}
                                              active={this.state.selectedItem === TREMENDOUS_WEATHER_CONFIG.path }/>
                                <Divider/>
                            </List>
                        </Grow>
                    </ClickAwayListener>
